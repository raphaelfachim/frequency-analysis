...
if __name__ == '__main__':
    ...
    conteudo = ""
    acel = VariaveisSensor("", "", "ai12")
    acel_2 = VariaveisSensor("", "", "ai4")
    nome_raiz = "Dev4"
    amostra = 29
    limite = 31
    ...
    while amostra <= limite:
        ...
        caminho = "C:\\Users\\raphael.fachim\\Desktop\\frequency-analysis\\src\\model\\data-15-12\\Dev4_" + str(amostra) + ".txt"
        ...
        nome_figura = "C:\\Users\\raphael.fachim\\Desktop\\frequency-analysis\\{0}\\amostra-{1}.{2}".format(timestamp,
                                                                                                   str(amostra), "png")
